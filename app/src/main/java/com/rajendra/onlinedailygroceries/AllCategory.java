...
public class AllCategory extends AppCompatActivity {
    ...
    List<String> allCategoryModelList;
...
//        allCategoryModelList = (List<Product>) getIntent().getParcelableArrayListExtra("allCategory");
        Bundle bundle = getIntent().getExtras();
        allCategoryModelList = bundle.getStringArrayList("allCategory");
        setCategoryRecycler(allCategoryModelList);

    }

    private void setCategoryRecycler(List<String> allcategoryModelList) {
