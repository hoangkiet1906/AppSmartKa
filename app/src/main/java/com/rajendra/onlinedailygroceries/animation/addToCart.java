package com.rajendra.onlinedailygroceries.animation;
...
public class addToCart {
    ...
    public static void translateAnimation(final ImageView viewAnimation, @NonNull final View startView,
        ...
        float startViewWidthCenter = startView.getWidth()*0.75f;
        float startViewHeightCenter = startView.getHeight()/2;

        float endViewWitdhCenter = endView.getWidth()*0.75f;
        ...
        float toX = endPos[0] + endViewWitdhCenter - startViewWidthCenter;
        float fromY = (startPos[1] - startViewHeightCenter)*0.84f;
